...
import type { UIConfig, UIComponents } from '@gluestack-ui/themed';
...
const componentsConfig = createComponents(componentsTheme);
...
export type { IConfig, IComponents, UIConfig, UIComponents };
export { colors, config, componentsConfig, gluestackUIConfig };
